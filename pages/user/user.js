            ...
            var viewModel = {
                ...
                event: {
                                ...
                                if (res) {
                                    if (res.success == 'success') {
                                        if (res.detailMsg.data) {
                                            ...
                                            viewModel.userDa.setSimpleData(res.detailMsg.data.content, {
                                                unSelect: true
                                            });
                                            if (totleCount == 0) {
                    ...
                    editClick: function() {
                        ...
                        //绑定所选值
                        viewModel.userFormDa.setSimpleData(viewModel.userDa.getSimpleData({
                            type: 'select'
                        }));
                        viewModel.userJobFormDa.setSimpleData(viewModel.userJobDa.getSimpleData(), {
                            unSelect: true
                        });
                    ...
                    /**确认删除*/
                    delConfirm: function() {
                        var jsonDel = viewModel.userDa.getSimpleData({
                            type: 'select'
                        });
                        $.ajax({
                            type: "post",
                                ...
                                if (res) {
                                    if (res.success == 'success') {
                                        if (res.detailMsg.data) {
                                            viewModel.userJobDa.removeAllRows();
                                            viewModel.userJobDa.clear();
                                            viewModel.userJobDa.setSimpleData(res.detailMsg.data.content, {
                                                unSelect: true
                                            });

                                            viewModel.userJobFormDa.setSimpleData(res.detailMsg.data.content, {
                                                unSelect: true
                                            });
                                            var totleCount = res.detailMsg.data.totalElements;
                                            var totlePage = res.detailMsg.data.totalPages;
                    ...
                    delUserJob: function() {
                        var userJobs = viewModel.userJobFormDa.getSimpleData({
                            type: 'select'
                        })
                        ...
                        /* if (confirm("确定要删除吗?"))*/
                        function confirmUJF() {
                            var jsonDel = viewModel.userJobFormDa.getSimpleData({
                                type: 'focus'
                            });
